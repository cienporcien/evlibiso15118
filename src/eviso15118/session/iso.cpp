...
static void log_sdp_packet(const eviso15118::io::SdpPacket& sdp) {
    ...
    eviso15118::logf("[SDP Packet in]: Header: %04hx, Payload: %s", sdp.get_payload_type(), payload_string_buffer.get());
}

static void log_packet_from_car(const eviso15118::io::SdpPacket& packet, session::SessionLogger& logger) {
...
static std::unique_ptr<message_20::Variant> make_variant_from_packet(const eviso15118::io::SdpPacket& packet) {
