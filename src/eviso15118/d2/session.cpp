...
bool Session::find_parameter_set_id(const message_2::ServiceCategory service, int16_t id) {
...
void Session::selected_service_parameters(const message_2::ServiceCategory service, const uint16_t id) {
    ...
    case message_2::ServiceCategory::DC:
        ...
        if (this->offered_services.dc_parameter_list.find(id) != this->offered_services.dc_parameter_list.end()) {
            ...
            this->selected_services =
                SelectedServiceParameters(message_2::ServiceCategory::DC, parameters.connector,
    ...
    case message_2::ServiceCategory::DC_BPT:
        if (this->offered_services.dc_bpt_parameter_list.find(id) !=
            ...
            this->selected_services = SelectedServiceParameters(
                message_2::ServiceCategory::DC_BPT, parameters.connector, parameters.control_mode,
    ...
    case message_2::ServiceCategory::Internet:
        ...
        if (this->offered_services.internet_parameter_list.find(id) !=
            this->offered_services.internet_parameter_list.end()) {
            this->selected_vas_services.vas_services.push_back(message_2::ServiceCategory::Internet);
    ...
    case message_2::ServiceCategory::ParkingStatus:
        ...
        if (this->offered_services.parking_parameter_list.find(id) !=
            this->offered_services.parking_parameter_list.end()) {
            this->selected_vas_services.vas_services.push_back(message_2::ServiceCategory::ParkingStatus);
