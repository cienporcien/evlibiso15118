...
exi_bitstream_t get_exi_input_stream(const eviso15118::io::StreamInputView& buffer_view) {
...
exi_bitstream_t get_exi_output_stream(const eviso15118::io::StreamOutputView& buffer_view) {
