...
CREATE_TYPE_TRAIT(ACDS_VehiclePositioningResponse, ACDS_VehiclePositioningRes);
...
CREATE_TYPE_TRAIT(ACDS_ConnectResponse, ACDS_ConnectRes);
...
CREATE_TYPE_TRAIT(ACDS_DisconnectResponse, ACDS_DisconnectRes);
