...
CREATE_TYPE_TRAIT(ACDS_VehiclePositioningRequest, Part20ACDS);
...
CREATE_TYPE_TRAIT(ACDS_ConnectRequest, Part20ACDS);
...
CREATE_TYPE_TRAIT(ACDS_DisconnectRequest, Part20ACDS);
