...
struct VariantAccess {
    ...
    // output
    void*& data;
    eviso15118::message_2_sap::Type& type;
    eviso15118::message_2_sap::Variant::CustomDeleter& custom_deleter;
    std::string& error;
    ...
    template <typename MessageType, typename CbExiMessageType> void insert_type(const CbExiMessageType& in) {
        ...
        type = eviso15118::message_2_sap::TypeTrait<MessageType>::type;
