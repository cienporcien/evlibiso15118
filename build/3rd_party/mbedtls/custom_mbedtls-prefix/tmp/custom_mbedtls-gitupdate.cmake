...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "mbedtls-3.5.0"
  WORKING_DIRECTORY "/home/opbrid/checkout/everest_main/evlibiso15118/build/3rd_party/mbedtls/custom_mbedtls-prefix/src/custom_mbedtls"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "mbedtls-3.5.0")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("mbedtls-3.5.0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/mbedtls-3.5.0")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/opbrid/checkout/everest_main/evlibiso15118/build/3rd_party/mbedtls/custom_mbedtls-prefix/src/custom_mbedtls'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/opbrid/checkout/everest_main/evlibiso15118/build/3rd_party/mbedtls/custom_mbedtls-prefix/src/custom_mbedtls'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
